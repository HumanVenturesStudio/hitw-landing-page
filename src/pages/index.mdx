...
<section>
  <img src="/images/nume-kit.png" class="nume-kit hidden--mobile" alt="nu me &mdash; Morning Munchies Power Powder 01" />
</section>
<section>

### Healing nutrients for postpartum women,<br/>made easy.

**nu me** is your daily superfood nourishing broth, made in seconds with hot water. Based on centuries of herbal science to provide better, faster postpartum recovery.
  ...
  <Accordion
    ...
    items={[
      ...
      },
      {
        ...
        If you're giving birth soon (good luck!), this is for you - order in advance and set aside for when the baby comes home.  You'll thank yourself for preparing when life feels all about the baby afterwards.
      ...
      },
      {
        ...
        content: `Detoxes & depuffs. Heals & replenishes lost blood & nutrients. Rejuvenates & energizes. Prevents future long-term ailments and premature aging.
        Packed with quality, flash-frozen, powderized functional foods (like sprouted amaranth, apricot, apples) Traditional Chinese Medicine herbs (Angelica sinensi, Eucommia ulmoides) and Ayurvedic spices (Ajwain seeds, Tumeric), nu me’s quintessential power powders are formulated through a deep understanding for ancient healing ingredients from around the world that have been used for thousands of years. Often, these ingredients are inaccessible or time-consuming to prepare, especially for a mother juggling a newborn. With modern food science, we’re able to tap into these ancient ingredients, combined with quality functional foods, to provide a nutrient-dense powder that can be prepared instantly into a super food bowl to promote a better recovery and long term healing for women.`,
      },
      {
        ...
        Take it daily after giving birth (& especially those first 40 days / 6 weeks) for best results.`,
      },
      {
        id: `how-do-i-take-it`,
      ...
      },
      {
        ...
        The goal is to make sure we get your body the nutrients you uniquely need as well as the additional ones to pass onto the baby if you’re nursing. In fact, many of the active ingredients are tried & true remedies to aid in breastfeeding, used in cultures around the world for centuries on generations upon generations of mothers.`,
      },
      {
